  ...
  <section class="home bd-grid" id="home">
    <div data-aos="fade-up">
      ...
      <div class="home__data">
        ...
        <p class="mb-3">Email : ayeayeaungjob96@gmail.com</p>
        <a
        ...
        <br />
        <a
          href="https://www.linkedin.com/in/aa-aung-34a814294/"
          class="button text-decoration-none mb-2"
          target="_blink"
          >Check My Resume</a
        >
      ...
      <div class="home__social mt-2 ms-3">
        ...
        ></a>
        <a href="https://github.com/KaKeMono96" class="home__social-icon"
          ><i class="fa-brands fa-github" target="_blink"></i
        ></a>

        <a href="tel:+959254741953" class="home__social-icon"
